...
const initialState : ModelVersionGroupSliceState={ modelversiongroups:  [
    {description: 'csac', modelVersionGroupName: 'asc', testingMode: 'MANUAL', guidId: 'a6e4ad89-4931-fdb0-1887-989d67025fbb'},
    {description: 'Second', modelVersionGroupName: 'second2', testingMode: 'MANUAL', guidId: 'a6e4ad89-4931-fdb0-1887-989d67025fbb'}]};    
