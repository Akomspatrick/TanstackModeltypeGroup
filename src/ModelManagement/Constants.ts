...
export const BaseURLs: URLs = {
  ModelManagementURL: 'http://localhost:5007/',
  ProductionManagementURL: 'http://localhost:5008/',
  RegistrationManagementURL: 'http://localhost:5009/',
  RMAManagementURL: 'http://localhost:5010/',
